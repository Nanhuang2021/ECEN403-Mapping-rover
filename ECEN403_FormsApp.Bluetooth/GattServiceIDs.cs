...
namespace ECEN403_FormsApp.Bluetooth
{
    public class GattServiceIDs : IReadOnlyCollection<GattService>
    {
        ...
        private readonly IReadOnlyCollection<GattService> nCollection;
        ...
        /// </summary>
        public int Count => nCollection.Count;
        ...
        {
            nCollection = new List<GattService>(new[]
            {
        ...
        /// </summary>
        /// <returns></returns>
        public IEnumerator<GattService> GetEnumerator() => nCollection.GetEnumerator();

        /// <summary>
        /// Gets the underlying enumerator of the collection
        /// </summary>
        /// <returns></returns>
        IEnumerator IEnumerable.GetEnumerator() => nCollection.GetEnumerator();
